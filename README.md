...
- 📋 **Paste clipboard in chunks** - splits large clipboard content into smaller chunks and sends each as a separate message, with optional Discord markdown formatting (quotes or code blocks)
